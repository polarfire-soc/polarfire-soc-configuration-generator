...
#------------------------------------------------------------------------------
reference_xml_file = \
    'hardware_des_xml,src_example,pf_soc_hw_description_reference.xml'
xml_tag_file = 'hardware_des_xml,src_example,pf_soc_hw_tag_reference.xml'
...
def WriteCopyright(root, theFile, filename, creator):
    ...
    theFile.write(' * PolarFire SoC Configuration Generator version: ' + get_cg_ver() + "\n")
    strings = ('',
